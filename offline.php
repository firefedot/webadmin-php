...
$qr_result = mysql_query("select server, name_vm, ip, login, passwd, client, online, download, ext_ip, emulation, activate, data_active from " . $db_table_to_show . " WHERE online = 0 order by name_vm ")
or die(mysql_error());
